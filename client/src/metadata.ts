...
export function parseMetadataResponse(response: MetadataApiResponse): MetadataResult {
  ...
  return {
    kind: 'missing',
    message: response.warnings?.join('; ') || 'Metadata is not available for this plan.',
  }
}
